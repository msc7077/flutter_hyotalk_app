...
import 'package:flutter_hyotalk_app/core/router/router_refresh_stream.dart';
    ...
    return GoRouter(
      ...
      routes: [
        GoRoute(
          path: '/splash',
          name: 'splash',
          pageBuilder: (context, state) => _buildFadePage(context, state, const SplashPage(), isFadeOut: true),
        ),
        GoRoute(
          path: '/login',
          name: 'login',
          pageBuilder: (context, state) => _buildFadePage(context, state, const LoginPage(), isFadeIn: true),
        ),
        ShellRoute(
          ...
          routes: [
            GoRoute(path: '/home', name: 'home', builder: (context, state) => const SizedBox.shrink()),
            GoRoute(path: '/work-diary', name: 'work-diary', builder: (context, state) => const SizedBox.shrink()),
            GoRoute(path: '/shopping', name: 'shopping', builder: (context, state) => const SizedBox.shrink()),
          ],
        ),
        GoRoute(path: '/mypage', name: 'mypage', builder: (context, state) => const MypageTabPage()),
        GoRoute(
          path: '/category/:id',
