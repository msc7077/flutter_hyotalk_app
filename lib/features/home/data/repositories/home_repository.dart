...
class HomeRepository {
  ...
  Future<HomeModel> getAgencyInfo(String agencyId) async {
    ...
    return HomeModel.fromJson({
      ...
      'menu_categories': [
        {'id': '1', 'name': '공지사항', 'icon': 'notice', 'route': '/notice-list'},
        {'id': '2', 'name': '알림장', 'icon': 'note', 'route': '/note-list'},
        {'id': '3', 'name': '어르신정보', 'icon': 'senior', 'route': '/senior-info'},
        {'id': '4', 'name': '직원출근부', 'icon': 'attendance', 'route': '/attendance'},
        {'id': '5', 'name': '생활교육', 'icon': 'education', 'route': '/education'},
        {'id': '6', 'name': '오늘의 영상', 'icon': 'video', 'route': '/video'},
      ],
    });
  }
}
